...
public class KnowledgeIngestServiceRedisTest {
    ...
    void testStartSummaryTask_WithGarbageDataInRedis() {
        // 1. Simulate setIfAbsent throwing exception (simulating what happens when
        // existing value is weird,
        // although StringRedisTemplate usually just overwrites, but we want to test the
        // catch block logic
